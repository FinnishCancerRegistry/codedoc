...
codedoc_news_df_to_markdown_news <- function(
  ...
  # @codedoc_comment_block news("codedoc::codedoc_news_df_to_markdown_news", "2022-03-03", "0.3.1")
...
markdown_comment_regex <- function() {
  "<!--"
}
markdown_comment_do_not_modify <- function() {
...
codedoc_news_for_R_package <- function(
  ...
  # @codedoc_comment_block news("codedoc::codedoc_news_for_R_package", "2022-03-03", "0.3.1")
  # `[codedoc::codedoc_news_for_R_package]` avoids markdown comments in
  # output (but they are included in `NEWS.md`).
  # @codedoc_comment_block news("codedoc::codedoc_news_for_R_package", "2022-03-03", "0.3.1")
  lines <- lines[!grepl(markdown_comment_regex(), lines)]
  c(
    "@section News:",
    "",
    lines
