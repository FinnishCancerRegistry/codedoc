...
#' @param detect_allowed_keys see `[codedoc::extract_keyed_comment_blocks_]`
#' @param text_file_paths see `[codedoc::extract_keyed_comment_blocks_]`
#' @param extract_arg_list
#'
#' - `NULL`: no additional args
#' - `list`: these args are passed to `[codedoc::extract_keyed_comment_blocks_]`
#' @param assertion_type see `[dbc::report_to_assertion]`
#' @name codedoc_lines
NULL
